...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/hidata/HIRun2015/HIMinimumBias1/RAW/v1/000/262/640/00000/10C1AEAA-F395-E511-AFB2-02163E013734.root')
)
...
process.trigsel = cms.EDFilter("HLTHighLevel",
    HLTPaths = cms.vstring('HLT_L1BptxMinus_v2'),
...
process.MBana = cms.EDAnalyzer("MBtriggerEfficiency",
    beam1_empty_bx = cms.untracked.vint32(188, 189, 190, 191, 192, 
        193, 194, 195, 196, 197, 
        198, 199),
    beam2_empty_bx = cms.untracked.vint32(135, 136, 137, 138, 139, 
        140, 141, 142, 143, 144, 
        145, 146),
    ...
    selected_lumi = cms.untracked.vint32(270, 464),
...
process.p = cms.Path(process.hcalDigis+process.ecalDigis+process.ecalPreshowerDigis+process.gtDigis+process.gctDigis+process.trigsel+process.pixelTrackFilter+process.MBana)

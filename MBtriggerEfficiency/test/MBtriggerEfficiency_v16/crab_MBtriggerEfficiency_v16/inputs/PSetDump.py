...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://cmsxrootd.fnal.gov//store/data/Run2016B/EmptyBX/RAW/v2/000/273/523/00000/18C906EF-561C-E611-AB79-02163E014489.root')
)
...
process.pixelTrackFilter = cms.EDFilter("PixelTrackFilter",
...
process.MBana = cms.EDAnalyzer("MBtriggerEfficiency",
    beam1_empty_bx = cms.untracked.vint32(222, 262, 302, 342, 382, 
        422, 462, 502, 1112, 1152, 
        1192, 1232, 1272, 1312, 1352, 
        1392, 1432, 1472, 1512, 1552, 
        1800, 1840, 1880, 1920, 2344, 
        2384, 2424, 2464, 2504, 2544, 
        2584, 2624, 2794, 2834, 2874, 
        2954, 2994, 3034, 3074, 3114, 
        3154, 3194, 3234),
    beam2_empty_bx = cms.untracked.vint32(121, 161, 201, 241, 281, 
        321, 361, 401, 441, 481, 
        521, 561, 1450, 1490, 1530, 
        1570, 2003, 2043, 2083, 2123, 
        2163, 2203, 2243, 2283, 2323, 
        2363, 2403, 2443, 2691, 2731, 
        2771, 2811, 2892, 2932, 2972, 
        3012, 3052, 3092, 3132, 3172),
    ...
    selected_lumi = cms.untracked.vint32(1, 227),
    useBPTXminus = cms.bool(True),
...
process.L1TRawToDigi_Stage2 = cms.Sequence(process.bmtfDigis+process.caloStage2Digis+process.gmtStage2Digis+process.gtStage2Digis)
...
process.RawToDigi = cms.Sequence(process.L1TRawToDigi+process.siPixelDigis+process.siStripDigis+process.ecalDigis+process.ecalPreshowerDigis+process.hcalDigis+process.muonCSCDigis+process.muonDTDigis+process.muonRPCDigis+process.castorDigis+process.scalersRawToDigi+process.tcdsDigis+process.totemTriggerRawToDigi+process.totemRPRawToDigi)
...
process.RawToDigi_noTk = cms.Sequence(process.L1TRawToDigi+process.ecalDigis+process.ecalPreshowerDigis+process.hcalDigis+process.muonCSCDigis+process.muonDTDigis+process.muonRPCDigis+process.castorDigis+process.scalersRawToDigi+process.tcdsDigis+process.totemTriggerRawToDigi+process.totemRPRawToDigi)
...
process.p = cms.Path(process.hcalDigis+process.ecalDigis+process.ecalPreshowerDigis+process.gtDigis+process.gctDigis+process.trigsel+process.MBana)
